...
const FluidShaderMaterial = shaderMaterial(
  {
    ...
    uScroll: 0.0,
    uColorObsidian: new THREE.Color('#050505'),
    uColorSilver: new THREE.Color('#E5E5E5')
  },
  // Vertex Shader
  `
    varying vec2 vUv;
  ...
  `
    ...
    void main() {
      ...
      // Calculate mouse influence - Stronger repulsion radius for the custom cursor
...
export default FluidShaderMaterial;
